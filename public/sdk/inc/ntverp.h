...
#define VER_PRODUCTESUPBLDDATE_STR  "2016-05-01"
#define VER_PRODUCTESUPBLDDATE_Y    2016
#define VER_PRODUCTESUPBLDDATE_M    5
#define VER_PRODUCTESUPBLDDATE_D    1
#define VER_PRODUCTESUPBUILDER_STR  "MinNT.trunk-stephanosanio"
