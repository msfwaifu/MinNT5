...
static const RPC_CLIENT_INTERFACE llsrpc___RpcClientInterface =
    {
...
RPC_IF_HANDLE llsrpc_ClientIfHandle = (RPC_IF_HANDLE)& llsrpc___RpcClientInterface;

extern const MIDL_STUB_DESC llsrpc_StubDesc;

static RPC_BINDING_HANDLE llsrpc__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ LPWSTR Name)
{
    ...
    RpcTryFinally
        ...
        NdrClientInitializeNew(
                          ...
                          ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                          0);
        
        
        _Handle = llsrpc_handle;
    ...
    /* [in] */ LLS_HANDLE Handle)
{
    ...
    RpcTryFinally
        ...
        if(Handle != 0)
            {
            _Handle = NDRCContextBinding(( NDR_CCONTEXT  )Handle);;
    ...
    /* [unique][out][in] */ LPDWORD ResumeHandle)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 0U + 11U + 14U;
        ...
        *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++ = PrefMaxLen;
        ...
        _StubMsg.Buffer = (unsigned char __RPC_FAR *)(((long)_StubMsg.Buffer + 3) & ~ 0x3);
        *TotalEntries = *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++;
    ...
    /* [string][in] */ LPWSTR Version)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 14U + 14U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)ProductFamily,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [unique][out][in] */ LPDWORD ResumeHandle)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 0U + 11U + 14U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)Product,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [switch_is][out] */ PLLS_USER_INFOW __RPC_FAR *BufPtr)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 10U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
    ...
    /* [switch_is][out] */ PLLS_USER_INFOA __RPC_FAR *BufPtr)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 11U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)User,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[980] );
    ...
    /* [switch_is][in] */ PLLS_USER_INFOW BufPtr)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 10U + 0U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)User,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [switch_is][in] */ PLLS_USER_INFOA BufPtr)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 11U + 0U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)User,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[980] );
    ...
    /* [string][in] */ LPWSTR Product)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 14U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)User,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [in] */ LPSTR Product)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 2U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)User,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[980] );
        ...
        *(( CHAR __RPC_FAR * )_StubMsg.Buffer)++ = *Product;
    ...
    /* [switch_is][out] */ PLLS_MAPPING_INFOW __RPC_FAR *BufPtr)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 10U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)Mapping,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [unique][out][in] */ LPDWORD ResumeHandle)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 12U + 0U + 11U + 14U;
        NdrConformantStringBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                       (unsigned char __RPC_FAR *)Server,
                                       (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[10] );
    ...
    /* [size_is][in] */ REPL_SERVERS Servers)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 4U + 8U;
        _StubMsg.MaxCount = NumRecords;
        
        NdrPointerBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR *)Servers,
        ...
        NdrClientContextMarshall(
                            ...
                            ( NDR_CCONTEXT  )Handle,
                            1);
        *(( ULONG __RPC_FAR * )_StubMsg.Buffer)++ = NumRecords;
    ...
    /* [size_is][in] */ REPL_SERVER_SERVICES ServerServices)
{
    ...
    RpcTryFinally
        ...
        NdrPointerBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR *)ServerServices,
    ...
    /* [size_is][in] */ REPL_SERVICES Services)
{
    ...
    RpcTryFinally
        ...
        NdrPointerBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR *)Services,
    ...
    /* [out] */ LPBOOL pIsSecure)
{
    ...
    RpcTryFinally
        ...
        *pIsSecure = *(( BOOL __RPC_FAR * )_StubMsg.Buffer)++;
    ...
    /* [out] */ LPDWORD pQuantity)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.Buffer = (unsigned char __RPC_FAR *)(((long)_StubMsg.Buffer + 3) & ~ 0x3);
        *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++ = Mode;
        ...
        *pQuantity = *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++;
    ...
    /* [out][in] */ PLLS_CERTIFICATE_CLAIM_ENUM_STRUCTA ClaimInfo)
{
    ...
    RpcTryFinally
        ...
        _StubMsg.BufferLength = 20U + 4U + 0U + 0U;
        ...
        NdrClientContextMarshall(
                            ...
                            ( NDR_CCONTEXT  )Handle,
                            1);
        *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++ = LicenseLevel;
    ...
    /* [out] */ LPBOOL pbMayInstall)
{
    ...
    RpcTryFinally
        ...
        *pbMayInstall = *(( BOOL __RPC_FAR * )_StubMsg.Buffer)++;
    ...
    /* [switch_is][in] */ REPL_CERTIFICATES Certificates)
{
    ...
    RpcTryFinally
        ...
        NdrPointerBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR *)Certificates,
    ...
    /* [switch_is][in] */ REPL_SECURE_PRODUCTS SecureProducts)
{
    ...
    RpcTryFinally
        ...
        NdrPointerBufferSize( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR *)SecureProducts,
    ...
    /* [size_is][out] */ LPBYTE pbCapabilities)
{
    ...
    RpcTryFinally
        ...
        NdrClientContextMarshall(
                            ...
                            ( NDR_CCONTEXT  )Handle,
                            1);
        *(( DWORD __RPC_FAR * )_StubMsg.Buffer)++ = cbCapabilities;
        ...
        NdrConformantArrayUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                                      (unsigned char __RPC_FAR * __RPC_FAR *)&pbCapabilities,
...
static const MIDL_STUB_DESC llsrpc_StubDesc = 
    {
    (void __RPC_FAR *)& llsrpc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &llsrpc_handle,
    0,
