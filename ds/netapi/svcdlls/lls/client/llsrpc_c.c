    ...
    /* [in] */ LLS_HANDLE Handle)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[16],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [string][in] */ LPWSTR Version)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[210],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [unique][out][in] */ LPDWORD ResumeHandle)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[342],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [unique][out][in] */ LPDWORD ResumeHandle)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[518],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [switch_is][in] */ PLLS_USER_INFOA BufPtr)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[634],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [switch_is][in] */ PLLS_SERVICE_INFOA BufPtr)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1666],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [out][in] */ LLS_REPL_HANDLE __RPC_FAR *Handle)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1706],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [size_is][in] */ REPL_SERVERS Servers)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1748],
                 ( unsigned char __RPC_FAR * )&Handle,
                 ( unsigned char __RPC_FAR * )&NumRecords,
    ...
    /* [out] */ LPBOOL pIsSecure)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char __RPC_FAR * )&Handle,
                 ( unsigned char __RPC_FAR * )&Product,
                 ( unsigned char __RPC_FAR * )&pIsSecure);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1844],
    ...
    /* [out] */ LPDWORD pQuantity)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char __RPC_FAR * )&pQuantity);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1940],
    ...
    /* [out][in] */ PLLS_CERTIFICATE_CLAIM_ENUM_STRUCTA ClaimInfo)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[1996],
                 ( unsigned char __RPC_FAR * )&Handle,
                 ( unsigned char __RPC_FAR * )&LicenseLevel,
    ...
    /* [out] */ LPBOOL pbMayInstall)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char __RPC_FAR * )&Level,
                 ( unsigned char __RPC_FAR * )&LicensePtr,
                 ( unsigned char __RPC_FAR * )&pbMayInstall);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[2052],
    ...
    /* [size_is][out] */ LPBYTE pbCapabilities)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[2236],
                 ( unsigned char __RPC_FAR * )&Handle,
                 ( unsigned char __RPC_FAR * )&cbCapabilities,
...
#if defined( _ALPHA_ )
    va_start(vlist,LocalServiceInfo);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&llsrpc_StubDesc,
