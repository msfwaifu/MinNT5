...
#ifndef __logon_c_h__
#define __logon_c_h__
...
typedef struct _NLPR_SID_INFORMATION __RPC_FAR *PNLPR_SID_INFORMATION;
...
typedef /* [allocate] */ struct _NETLOGON_DELTA_ENUM_ARRAY __RPC_FAR *PNETLOGON_DELTA_ENUM_ARRAY;
